    ...
    <main class="text-center h-screen absolute w-full inset-y-0 bg-gradient-to-r from-[#3742d0] to-[#1f2895]">
        ...
        <div class="grid justify-center">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" id="login" placeholder="Enter email or plid" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100">
            </div>
