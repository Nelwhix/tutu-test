<script setup lang="ts">
    ...
    <template>
        <main class="text-center h-screen absolute w-full inset-y-0 bg-gradient-to-r from-[#3742d0] to-[#1f2895]">
            ...
            <div>
                <form class="mt-4 py-10 px-10 bg-white w-full rounded-lg drop-shadow-lg">
                <div class="flex flex-col">
                    <label for="platform" class="text-start">Platform</label>
                    <input type="text" id="platform" placeholder="Enter name" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100">
                </div>
                <div class="flex justify-between">
                    <div class="flex flex-col mt-4">
                        <label for="email" class="text-start">Email</label>
                    <input type="email" id="email" placeholder="example@domain.com" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100 w-72">
                    </div>
                    <div class="flex flex-col mt-4">
                        <label for="website" class="text-start">Domain</label>
                        <input type="url" id="website" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100 w-68">
                    </div>
                </div>
                <div class="flex flex-col mt-4">
                    <label for="desc" class="text-start">Description</label>
                    <textarea id="desc" cols="30" rows="5" class="overflow-scroll focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100"></textarea>
                </div>
                <div class="flex justify-between">
                    <div class="flex flex-col mt-5 relative">
                        <label for="pwd" class="text-start">Password</label>
                        <input v-model="password" v-if="showPassword" type="text" id="pwd" placeholder="Enter Password" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100"/>
                        <input v-model="password" v-else type="password" id="pwd" placeholder="Enter Password" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100"/>
                    ...
                    <input v-model="password_confirmation" v-if="showPasswordConfirmation" type="text" id="pwd" placeholder="Confirm Password" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100"/>
                    <input v-model="password_confirmation" v-else type="password" id="pwd" placeholder="Confirm Password" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100"/>
