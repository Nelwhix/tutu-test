            ...
            <div class="md:grid md:justify-center">
                ...
                <div class="flex justify-between">
                    <div class="flex flex-col mt-4">
                        ...
                        <input v-model="formData.email" type="email" id="email" placeholder="example@domain.com" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100 w-72">
                        <span v-if="v$.email.$error" class="text-red-400">{{ v$.email.$errors[0].$message }}</span>
                    </div>
                    <div class="flex flex-col mt-4">
                        <label for="website" class="text-start">Domain</label>
                        <input v-model="formData.domain" type="url" id="website" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100 w-68">
                ...
                <div class="flex justify-between gap-3">
                    <div class="flex flex-col mt-5 relative w-[50%]">
                        ...
                        <input v-model="formData.password" v-else type="password" id="pwd" placeholder="Enter Password" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100"/>
                    ...
                    <input v-model="formData.password_confirmation" v-if="showPasswordConfirmation" type="text" id="pwd" placeholder="Confirm Password" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100"/>
                    <input v-model="formData.password_confirmation" v-else type="password" id="pwd" placeholder="Confirm Password" class="focus:outline focus:outline-[3px] border rounded-md pl-3 py-3 mt-2 focus:border-blue-100 focus:outline-blue-200 focus:bg-gray-100"/>
